...
class meritScholarships extends StatefulWidget {
  ...
  @override
  State<meritScholarships> createState() => _meritScholarshipsState();
}

class _meritScholarshipsState extends State<meritScholarships> {
  ...
  void _addScholarship() async {
    ...
    if (title.isNotEmpty && description.isNotEmpty && url.isNotEmpty) {
      await FirebaseFirestore.instance.collection('scholarships').add({
        ...
        'url': url,
        'category': 'Merit-based', // Ensures the correct category
      });
        ...
        body: Stack(children: [
          StreamBuilder<QuerySnapshot>(
            stream: FirebaseFirestore.instance
                ...
                .where('category', isEqualTo: 'merit-based')
                .snapshots(),
